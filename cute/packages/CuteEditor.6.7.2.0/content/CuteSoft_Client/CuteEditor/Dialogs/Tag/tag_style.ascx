...
var OxOccda=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOccda[1],true)[OxOccda[0]]=function (){if(event[OxOccda[2]]){alert(element[OxOccda[3]].cssText);} ;} ;
</script>
