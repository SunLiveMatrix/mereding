...
<script type="text/javascript">
var OxO3a2e=["ua","userAgent","isOpera","opera","isSafari","safari","isGecko","gecko","isWinIE","msie","isMac","Mac","availWidth","dialogWidth","availHeight","dialogHeight"];var _Browser_TypeInfo=null;function Browser__InitType(){if(_Browser_TypeInfo!=null){return ;} ;var Ox4={};Ox4[OxO3a2e[0]]=navigator[OxO3a2e[1]].toLowerCase();Ox4[OxO3a2e[2]]=(Ox4[OxO3a2e[0]].indexOf(OxO3a2e[3])>-1);Ox4[OxO3a2e[4]]=(Ox4[OxO3a2e[0]].indexOf(OxO3a2e[5])>-1);Ox4[OxO3a2e[6]]=(!Ox4[OxO3a2e[2]]&&!Ox4[OxO3a2e[4]]&&Ox4[OxO3a2e[0]].indexOf(OxO3a2e[7])>-1);Ox4[OxO3a2e[8]]=(!Ox4[OxO3a2e[2]]&&Ox4[OxO3a2e[0]].indexOf(OxO3a2e[9])>-1);Ox4[OxO3a2e[10]]=navigator[OxO3a2e[1]].indexOf(OxO3a2e[11])!=-1;_Browser_TypeInfo=Ox4;} ;Browser__InitType();function Browser_IsWinIE(){return _Browser_TypeInfo[OxO3a2e[8]];} ;try{if(Browser_IsWinIE()){top.moveTo((screen[OxO3a2e[12]]-self[OxO3a2e[13]])/2,(screen[OxO3a2e[14]]-self[OxO3a2e[15]])/2);} else {} ;} catch(x){} ;
</script>
