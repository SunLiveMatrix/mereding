...
var OxObc0c=["postback","Save"];function doClose(){Window_SetDialogReturnValue(window,null);var OxO7372=[];Window_CloseDialog(window);} ;function CuteEditor_OnCommand(editor,Ox4d,Ox4e,Ox4f){if(Ox4d.toLowerCase()==OxObc0c[0]&&Ox4f==OxObc0c[1]){Window_SetDialogReturnValue(window,'<%= Request.QueryString["f"]%>');} ;} ;
</script>

<asp:Panel runat=server Visible=false id="savedpanel">
<script language="JavaScript" type="text/javascript" >
var OxO7372=[];Window_CloseDialog(window);
</script>
</asp:Panel>